...
var Init = function () {
    ...
    var handleTooltips = function () {
        if (Init.isTouchDevice()) { // if touch device, some tooltips can be skipped in order to not conflict with click events
    ...
    return {
        ...
        init: function () {
            ...
            Init.addResponsiveHandler(handleChoosenSelect); // reinitiate chosen dropdown on main content resize. disable this line if you don't really use chosen dropdowns.
        },
