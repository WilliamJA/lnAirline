    ...
    return {
        ...
        initMiniCharts: function () {
            ...
            $('.easy-pie-chart .number.transactions').easyPieChart({
                ...
                size: 75,
                lineWidth: 3,
                barColor: Init.getLayoutColorCode('yellow')
            });
            ...
            $('.easy-pie-chart .number.visits').easyPieChart({
                ...
                size: 75,
                lineWidth: 3,
                barColor: Init.getLayoutColorCode('green')
            });
            ...
            $('.easy-pie-chart .number.bounce').easyPieChart({
                ...
                size: 75,
                lineWidth: 3,
                barColor: Init.getLayoutColorCode('red')
            });
        ...
        initDashboardDaterange: function () {
            ...
            $('#dashboard-report-range').daterangepicker({
                ...
                function (start, end) {
                    Init.blockUI(jQuery("#dashboard"));
                    setTimeout(function () {
                        Init.unblockUI(jQuery("#dashboard"));
                        $.gritter.add({
                            title: 'Dashboard',
